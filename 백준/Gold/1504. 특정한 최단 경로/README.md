...
### 해설
<p>
두 점을 지나 1에서 N으로 도달하는 방법은 2가지 입니다.

 1. $1 \rightarrow u \rightarrow v \rightarrow N$
 2. $1 \rightarrow v \rightarrow u \rightarrow N$

따라서, 위의 두 경로의 최단거리를 구하고, 이를 비교하면 됩니다.

다익스트라의 시작점을 1, u, v로 하여 도착점이 u, v, N일 때의 거리를 구하여 비교하면 됩니다.
</p>
